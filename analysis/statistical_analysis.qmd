...
jdr_b_fit = cfa(jdr_b_model, data = data, std.lv = TRUE)
...
jdr_b_qrp_model = '
  ...
  # Structural model
  burnout ~ job_demands + job_resources
  qrp ~ burnout + job_demands + job_resources'

jdr_b_qrp_fit = cfa(jdr_b_qrp_model, data = data, std.lv = TRUE)
