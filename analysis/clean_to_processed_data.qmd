...
```{r}
#Items have to be relocated first due to a mistake when importing to Qualtrics
clean_data = clean_data |> 
  rename(role_stressor_1 = role_ambiguity_9,
         role_stressor_2 = role_ambiguity_5,
         role_stressor_3 = role_ambiguity_10,
         role_stressor_4 = role_ambiguity_6,
         role_stressor_5 = role_ambiguity_1,
         role_stressor_6 = role_ambiguity_4,
         role_stressor_7 = role_ambiguity_2,
         role_stressor_8 = role_ambiguity_7,
         role_stressor_9 = role_ambiguity_12,
...
reverse_ambiguity_columns = c("role_stressor_4", "role_stressor_5", "role_stressor_6", 
