...
```{r echo=FALSE}
raw_data_01 = read.csv(here::here("data/april_09_decisionlab.csv"))
raw_data_02 = read.csv(here::here("data/april_09_aczellab.csv"))
...
write.csv(participant_data, here::here("data/participant_checks.csv"), row.names = FALSE)
```
